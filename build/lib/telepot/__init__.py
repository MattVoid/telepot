...
class Bot(_BotBase):
    ...
    def _api_request_with_file(self, method, params, file_key, files_value, **kwargs):
        if _isstring(files_value[file_key]):
            params[file_key] = files_value[file_key]
            del files_value[file_key]
        if files_value != {}:
            return self._api_request(method, _rectify(params), files_value, **kwargs)
        else:
    ...
    def sendPhoto(self, chat_id, photo,
        ...
        photo = {'photo': photo}
        return self._api_request_with_file('sendPhoto', _rectify(p), file_key, photo)
    ...
    def sendAudio(self, chat_id, audio,
        ...
        files_value = {'audio': audio}
        if thumb != None: files_value['thumb'] = thumb 
        return self._api_request_with_file('sendAudio', _rectify(p), 'audio', files_value)
    ...
    def sendDocument(self, chat_id, document,
        ...
        """
        p = _strip(locals(), more=['thumb'])
        files_value = {'document': document} 
        if thumb != None: files_value['thumb'] = thumb
        return self._api_request_with_file('sendDocument', _rectify(p), 'document', files_value)
    ...
    def sendVideo(self, chat_id, video,
        ...
        """
        p = _strip(locals(), more=['thumb'])
        files_value = {'video': video} 
        if thumb != None: files_value['thumb'] = thumb
        return self._api_request_with_file('sendVideo', _rectify(p), 'video', files_value)
    ...
    def sendAnimation(self, chat_id, animation,
        ...
        """
        p = _strip(locals(), more=['thumb'])
        files_value = {'animation': animation} 
        if thumb != None: files_value['thumb'] = thumb
        return self._api_request_with_file('sendAnimation', _rectify(p), 'animation', files_value)
    ...
    def sendVideoNote(self, chat_id, video_note,
        ...
        """
        p = _strip(locals(), more=['thumb'])
        files_value = {'video_note': video_note} 
        if thumb != None: files_value['thumb'] = thumb
        return self._api_request_with_file('sendVideoNote', _rectify(p), 'video_note', files_value)
    ...
    def sendSticker(self, chat_id, sticker,
        ...
        return self._api_request_with_file('sendSticker', _rectify(p), 'sticker', files)
    ...
    def uploadStickerFile(self, user_id, png_sticker):
        ...
        png_sticker = {'png_sticker': png_sticker}
