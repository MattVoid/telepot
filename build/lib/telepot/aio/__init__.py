...
class Bot(_BotBase):
    ...
    async def sendAudio(self, chat_id, audio,
        ...
        return await self._api_request_with_file('sendAudio', _rectify(p), 'audio', files_value)
    ...
    async def sendDocument(self, chat_id, document,
        ...
        if thumb != None: files_value['thumb'] = thumb
        return await self._api_request_with_file('sendDocument', _rectify(p), 'document', files_value)
    ...
    async def sendVideo(self, chat_id, video,
        ...
        if thumb != None: files_value['thumb'] = thumb
        return await self._api_request_with_file('sendVideo', _rectify(p), 'video', files_value)
    ...
    async def sendAnimation(self, chat_id, animation,
        ...
        if thumb != None: files_value['thumb'] = thumb
        return await self._api_request_with_file('sendAnimation', _rectify(p), 'animation', files_value)
    ...
    async def sendVideoNote(self, chat_id, video_note,
        ...
        if thumb != None: files_value['thumb'] = thumb
        return await self._api_request_with_file('sendVideoNote', _rectify(p), 'video_note', files_value)
